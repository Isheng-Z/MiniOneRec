...
def train(
    ...
    # 1. SidSFTDataset (With Hints)
    print(">>> Loading Task 1: SidSFTDataset")
    train_data1 = SidSFTDataset(train_file, tokenizer, cutoff_len, sample, seed=seed, category=category, cf_hints_path=cf_hints_path)
    train_datasets.append(train_data1)
    
    # 2. SidItemFeatDataset
    print(">>> Loading Task 2: SidItemFeatDataset")
    train_data2 = SidItemFeatDataset(item_meta_path, sid_index_path, tokenizer, cutoff_len, sample, seed=seed, category=category)
    ...
    print(">>> Loading Task 5: TitleHistory2SidSFTDataset")
    ...
    # Validation
    val_dataset = SidSFTDataset(eval_file, tokenizer, cutoff_len, sample, seed=seed, category=category, test=False, cf_hints_path=cf_hints_path)
